//  نورهان محمد سعيد محمد عثمان  
// المنتجات 
// السلة 
// الشحن 
// العملاء 
 // المنتجات منتهية الصلحية 
// المنتجات خلصانة 
...
int main() {
    try {
        // إعداد التاريخ
        time_t futureDate = time(nullptr) + 60 * 60 * 24 * 365; // بعد سنة
        ...
        Product* scratchCard = new Product("Scratch Card", 50, 10); // غير منتهي، غير قابل للشحن
